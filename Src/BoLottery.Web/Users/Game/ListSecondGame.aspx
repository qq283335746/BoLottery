<%@ Page Title="十二星宮（十二選五）開獎歷史" Language="C#" MasterPageFile="~/Users/Users.Master" AutoEventWireup="true" CodeBehind="ListSecondGame.aspx.cs" Inherits="TygaSoft.Web.Users.Game.ListSecondGame" %>
                ...
                <table id="bindT" class="easyui-datagrid" title="" data-options="rownumbers:true,pagination:true,singleSelect:true,fitColumns:true,toolbar:'#toolbar'" style="height: auto;">
                    <thead>
                        <tr>
                            ...
                            <th data-options="field:'f2',width:100">投注總額</th>
                            <th data-options="field:'f3',width:100">中獎總額</th>
...
<script type="text/javascript">
    ...
    var currFun = {
        ...
        FormatLottery: function (value, row, index) {
            ...
            for (var i = 0; i < len; i++) {
                if (i == (len - 1)) {
                    if (row.ColorName.indexOf("綠") > -1) {
                        itemAppend += "<a class=\"ci_gr\">" + items[i] + "</a>";
                    }
                    else if (row.ColorName.indexOf("紅") > -1) {
                        itemAppend += "<a class=\"ci_rd\">" + items[i] + "</a>";
                    }
                    else if (row.ColorName.indexOf("黃") > -1) {
                        itemAppend += "<a class=\"ci_yl\">" + items[i] + "</a>";
                    }
                }
