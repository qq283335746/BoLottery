<%@ Page Title="八大明星戰神（四十選八）歷史開獎" Language="C#" MasterPageFile="~/Users/Users.Master" AutoEventWireup="true" CodeBehind="ListFirstGame.aspx.cs" Inherits="TygaSoft.Web.Users.Game.ListFirstGame" %>
...
<div class="box">
    ...
    <div class="c pd10">
        <div id="tt" class="easyui-tabs" data-options="onSelect:currFun.OnSelect">
            <div title="八大明星戰神（四十選八）" style="padding:10px;">
                ...
                <table id="bindT" class="easyui-datagrid" title="" data-options="rownumbers:true,pagination:true,singleSelect:true,fitColumns:true,toolbar:'#toolbar'" style="height: auto;">
                    <thead>
                        <tr>
                            ...
                            <th data-options="field:'f3',width:80">投注總額</th>
                            <th data-options="field:'f4',width:80">中奖總額</th>
                            <th data-options="field:'f5',width:110">開獎時間</th>
                            <th data-options="field:'f2',width:200,formatter:currFun.FormatLottery">開獎結果</th>
            ...
            <div title="十二星宮（十二選五）" style="overflow:auto;padding:20px;display:none;"></div>
...
<script type="text/javascript">
    ...
    var currFun = {
        ...
        FormatLottery: function (value, row, index) {
            ...
            for (var i = 0; i < len; i++) {
                if (i == (len - 1)) itemAppend += "<a class=\"ci_rd\">" + items[i] + "</a>";
                else itemAppend += "<a class=\"ci_bl\">" + items[i] + "</a>";
            }
