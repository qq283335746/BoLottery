<%@ Page Title="下級用戶當日統計" Language="C#" MasterPageFile="~/Users/Users.Master" AutoEventWireup="true" CodeBehind="ListUserDayLottery.aspx.cs" Inherits="TygaSoft.Web.Users.GameReport.ListUserDayLottery" %>
...
<table id="bindT" class="easyui-datagrid" title="" data-options="rownumbers:true,pagination:true,singleSelect:true,fitColumns:true,toolbar:'#toolbar'" style="height: auto;">
    ...
    <tbody>
        <asp:Repeater ID="rpData" runat="server">
            <ItemTemplate>
                <tr>
                    <td><%#((DateTime)Eval("LastUpdatedDate")).ToString("yyyy-MM-dd")%></td>
                    <td><%#Eval("UserName")%></td>
