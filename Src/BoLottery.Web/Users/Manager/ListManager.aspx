<%@ Page Title="已設置的管理員" Language="C#" MasterPageFile="~/Users/Users.Master" AutoEventWireup="true" CodeBehind="ListManager.aspx.cs" Inherits="TygaSoft.Web.Users.Manager.ListManager" %>
...
<div id="toolbar" style="padding:5px;">
    ...
    <a href="/u/tg" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'">設置管理員</a>
...
<table id="bindT" class="easyui-datagrid" title="已設置的管理員列表" data-options="rownumbers:true,pagination:true,singleSelect:true,toolbar:'#toolbar'">
<thead>
    <tr>
