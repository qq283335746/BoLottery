...
<div class="easyui-layout" data-options="fit:true">
    <div data-options="region:'east',title:'',split:true" style="width:230px; padding-left:10px;">
        <div id="toolbarRole" style="padding:5px;">
            将“<span id="lbUserName"></span>”添加到角色:
        </div>
        <table id="dgRole" class="easyui-datagrid" title="角色" data-options="rownumbers:true,singleSelect:true,border:false,toolbar:'#toolbarRole',onLoadSuccess:currFun.OnRoleLoadSuccess">
            <thead>
            <tr>
    ...
    <div data-options="region:'center',title:''">
        ...
        <table id="bindT" class="easyui-datagrid" title="用户列表" data-options="rownumbers:true,pagination:true,singleSelect:true,border:false,toolbar:'#toolbar'">
        <thead>
            <tr>
