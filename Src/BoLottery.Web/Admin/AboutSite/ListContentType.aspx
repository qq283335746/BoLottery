<%@ Page Title="內容類型管理" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ListContentType.aspx.cs" Inherits="TygaSoft.Web.Admin.ListContentType" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">

<div class="easyui-panel" title="内容類型管理" data-options="fit:true" style="padding:10px;"> 
...
<div id="dlg" class="easyui-dialog" title="新建/編輯内容類型" data-options="iconCls:'icon-save',closed:true,modal:true,
href:'/Templates/Admin/AddContentType.htm',buttons: [{
...
<script type="text/javascript">
    $(function () {
        $("#dlg").dialog('refresh', '/Templates/Admin/AddContentType.htm');
        currFun.Init();
    })
    ...
    var currFun = {
        ...
        Add: function () {
            currFun.Url = "/ScriptServices/AdminService.asmx/SaveContentType";
            var t = $("#treeCt");
        ...
        Del: function () {
            ...
            if (node) {
                $.messager.confirm('温馨提示', '確定要删除嗎?', function (r) {
                    if (r) {
        ...
        Save: function () {
            ...
            $.ajax({
                url: currFun.Url,
                type: "post",
                data: '{contentTypeModel:{Id:"' + $("#hId").val() + '",TypeName:"' + $("#txtName").val() + '",TypeCode:"' + $("#txtCode").val() + '",ParentId:"' + $("#hParentId").val() + '",Sort:' + sSort + '}}',
                contentType: "application/json; charset=utf-8",
                success: function (data) {
                    var msg = data.d;
                    if (msg == "1") {
