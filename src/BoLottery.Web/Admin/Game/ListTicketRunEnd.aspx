<%@ Page Title="用户投注列表" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ListTicketRunEnd.aspx.cs" Inherits="TygaSoft.Web.Admin.Game.ListTicketRunEnd" %>
...
<table id="bindT" class="easyui-datagrid" title="" data-options="rownumbers:true,pagination:true,singleSelect:true,fitColumns:true,toolbar:'#toolbar'" style="height: auto;">
    <thead>
        <tr>
            <th data-options="field:'f1',width:120">彩票类型</th>
            <th data-options="field:'f2',width:80">开奖期</th>
            <th data-options="field:'f3',width:120">用户</th>
            <th data-options="field:'f4',width:80">投注总额</th>
            <th data-options="field:'f5',width:80">中奖总额</th>
