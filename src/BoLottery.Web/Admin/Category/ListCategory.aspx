<%@ Page Title="分類管理" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ListCategory.aspx.cs" Inherits="TygaSoft.Web.Admin.ListCategory" %>
...
<div id="dlg" class="easyui-dialog" title="新建/編輯分類" data-options="iconCls:'icon-save',closed:true,modal:true,
...
<script type="text/javascript">
    ...
    var currFun = {
        ...
        Del: function () {
            ...
            if (node) {
                $.messager.confirm('温馨提示', '確定要刪除嗎?', function (r) {
                    if (r) {
