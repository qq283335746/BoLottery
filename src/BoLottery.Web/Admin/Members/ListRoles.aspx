...
<table id="bindT" class="easyui-datagrid" title="角色列表" data-options="rownumbers:true,singleSelect:true,toolbar:'#toolbar'" style="height:auto;">
<thead>
    <tr>
...
<ItemTemplate>
    <tr>
        ...
        <td><%#Eval("RoleName") %></td>
        <td>
            <a href='AddRoleUser.aspx?rName=<%#HttpUtility.UrlEncode(Eval("RoleName").ToString()) %>'>管理</a>
        </td>
    </tr>
</ItemTemplate>
</asp:Repeater>
        ...
        Del: function () {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    ...
                    $.ajax({
                        url: "/ScriptServices/AdminService.asmx/DelRole",
                        type: "post",
                    ...
                    if (msg == "1") {
                        if (roleId.length > 0) {
                            $('#bindT').datagrid('updateRow', {
                                ...
                                row: {
                                    f1: roleName,
                                    f2: "<a href=\"AddRoleUser.aspx?rName=" + roleName + "\">分配用戶</a>"
                                }
                            })
                        }
                        else {
